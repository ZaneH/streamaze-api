defmodule Streamaze.Accounts.User do
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    ...
    user
    |> cast(attrs, [:email, :password, :invite_code, :api_key])
    |> validate_email()
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Streamaze.Repo)
  ...
  """
  def valid_password?(%Streamaze.Accounts.User{hashed_password: hashed_password}, password)
